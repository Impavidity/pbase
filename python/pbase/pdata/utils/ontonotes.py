  ...
  def dataset_path_iterator(file_path):
    ...
    for root, _, files in list(os.walk(file_path)):
      for data_file in files:
        ...
        # In the testing dataset, the gold file is called filename.v?_gold_parse_conll
        if not data_file.endswith("gold_conll") and not data_file.endswith("gold_parse_conll"):
          continue
